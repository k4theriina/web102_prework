...
- I have an introductory knowledge of JavaScript, so doing this for the first time helped introduce me to a lot of useful fundementals.I mainly struggled with getting the syntax of certain functions right.
- Overall, the instrcutions as well as the teaching material was relatively easy to understand and helped me learn lots.

## License

    Copyright [2025] [Katherina Dayaon]
